...
한국 공공기관·공기업 또는 NCS 맥락이면 경험면접과 상황면접을 함께 구성하고, 직무기술서의 능력단위와 의사소통·문제해결·자원관리·대인관계·정보능력 등 직업기초능력을 실제 직무 상황에 연결한다.
상황면접은 가상의 업무상황을 주고 대응 절차, 판단 기준, 우선순위, 이해관계자 대응과 보고·협업 방식을 묻되 정답 암기형 질문으로 만들지 않는다.
...
export async function createTailoredQuestions(body = {}, options = {}) {
  ...
  parts.push({ text: JSON.stringify({
    ...
    rules: [
      ...
      '한국 공공기관·공기업·NCS 기반 채용이면 일부 workQuestions는 경험면접, 일부는 구체적인 업무 상황을 제시하는 상황면접으로 구성하고 NCS 직업기초능력과 직무기술서의 능력단위를 반영한다.',
      '상황면접 질문은 무엇을 하겠는지만 묻지 말고 첫 조치, 확인할 정보, 판단기준, 이해관계자 조율, 보고 또는 사후조치 중 필요한 요소를 검증할 수 있게 만든다.',
